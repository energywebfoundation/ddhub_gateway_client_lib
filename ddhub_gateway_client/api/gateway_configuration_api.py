...
class GatewayConfigurationApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.certificate_controller_save_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [],
                'endpoint_path': '/api/v2/certificate',
                'operation_id': 'certificate_controller_save',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.keys_controller_derive_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [],
                'endpoint_path': '/api/v2/keys',
                'operation_id': 'keys_controller_derive',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def keys_controller_derive(
        ...
        **kwargs
        ...
        """keys_controller_derive  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.keys_controller_derive(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.keys_controller_derive_endpoint.call_with_http_info(**kwargs)

...
class Status(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, details, name, *args, **kwargs):  # noqa: E501
        """Status - a model defined in OpenAPI

        Args:
            details ([Details]): details of messages sent or failed
    ...
    @convert_js_args_to_python_args
    def __init__(self, details, name, *args, **kwargs):  # noqa: E501
        """Status - a model defined in OpenAPI

...
class SendMessageDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, fqcn, topic_name, topic_version, topic_owner, transaction_id, payload, *args, **kwargs):  # noqa: E501
        """SendMessageDto - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, fqcn, topic_name, topic_version, topic_owner, transaction_id, payload, *args, **kwargs):  # noqa: E501
        """SendMessageDto - a model defined in OpenAPI

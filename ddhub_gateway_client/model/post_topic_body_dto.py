...
class PostTopicBodyDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, schema_type, schema, version, owner, tags, *args, **kwargs):  # noqa: E501
        """PostTopicBodyDto - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, schema_type, schema, version, owner, tags, *args, **kwargs):  # noqa: E501
        """PostTopicBodyDto - a model defined in OpenAPI
